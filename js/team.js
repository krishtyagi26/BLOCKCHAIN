/*
THIS CODE BY krishop#3290
*/
const boxOwners = document.getElementById("owners_list");
/*
you can use this api but if you need to create custome api check:
 https://github.com/krishtyagop/discord-web-api
*/
const API = "https://discord-web-api.glitch.me/discord/user/";

const owners = [
    {
        "id": "811857652480737280",
        "post": "FOUNDER OF Ktsys",
        "GHURL": "https://KRISH-TYAGI.krishtyagi2.repl.co",
        "InstaURL": "https://KRISH-TYAGI.krishtyagi2.repl.co",
        "YTURL": "https://KRISH-TYAGI.krishtyagi2.repl.co"
    }
]
